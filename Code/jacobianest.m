function [jac,jfevals,err] = jacobianest(fun,x0)
...
%
%  jfevals - number of times fun is evaluated
%
...
for i = 1:nx
  ...
  for j = 1:nsteps
    fdif = fun(swapelement(x0,i,x0_i + delta(j))) - ...
      fun(swapelement(x0,i,x0_i - delta(j))); jfevals = jfevals + 2;
